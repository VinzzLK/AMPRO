...
.method private Z(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    .locals 1
...
.method public static s(Lj$/time/temporal/TemporalAccessor;)Lj$/time/OffsetDateTime;
    ...
    invoke-interface {p0, v1}, Lj$/time/temporal/TemporalAccessor;->e(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, Lj$/time/temporal/TemporalAccessor;->e(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    ...
    .line 365
    :cond_1
    invoke-static {p0}, Lj$/time/Instant;->B(Lj$/time/temporal/TemporalAccessor;)Lj$/time/Instant;
...
.method public final W(JLj$/time/temporal/TemporalUnit;)Lj$/time/OffsetDateTime;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/LocalDateTime;->g0(JLj$/time/temporal/TemporalUnit;)Lj$/time/LocalDateTime;

    move-result-object p1

    iget-object p2, p0, Lj$/time/OffsetDateTime;->b:Lj$/time/ZoneOffset;

    invoke-direct {p0, p1, p2}, Lj$/time/OffsetDateTime;->Z(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
...
.method public final a(JLj$/time/temporal/p;)Lj$/time/temporal/Temporal;
    ...
    invoke-direct {p0, p1, v3}, Lj$/time/OffsetDateTime;->Z(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    ...
    invoke-direct {p0, v4, p1}, Lj$/time/OffsetDateTime;->Z(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
    ...
    .line 859
    :cond_1
    invoke-virtual {v4}, Lj$/time/LocalDateTime;->K()I
...
.method public final c(Lj$/time/LocalDate;)Lj$/time/temporal/Temporal;
    ...
    .line 911
    :cond_0
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->m0(Lj$/time/LocalDate;)Lj$/time/LocalDateTime;

    move-result-object p1

    invoke-direct {p0, p1, v1}, Lj$/time/OffsetDateTime;->Z(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
...
.method public compareTo(Lj$/time/OffsetDateTime;)I
    ...
    invoke-virtual {v0, v1}, Lj$/time/LocalDateTime;->a0(Lj$/time/chrono/ChronoLocalDateTime;)I
    ...
    invoke-interface {v4, v3}, Lj$/time/chrono/ChronoLocalDateTime;->toEpochSecond(Lj$/time/ZoneOffset;)J
    ...
    .line 823
    invoke-virtual {v4}, Lj$/time/LocalDateTime;->o()Lj$/time/LocalTime;
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->a0(Lj$/time/chrono/ChronoLocalDateTime;)I
...
.method public final f(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;
    ...
    invoke-interface {p1, v2, v3, v0}, Lj$/time/temporal/Temporal;->a(JLj$/time/temporal/p;)Lj$/time/temporal/Temporal;
...
.method public final h(Lj$/time/temporal/p;)J
    ...
    .line 639
    invoke-virtual {v3, p1}, Lj$/time/LocalDateTime;->h(Lj$/time/temporal/p;)J
    ...
    .line 1774
    :cond_1
    invoke-interface {v3, v2}, Lj$/time/chrono/ChronoLocalDateTime;->toEpochSecond(Lj$/time/ZoneOffset;)J
...
.method public final n(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/LocalDateTime;->n(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
