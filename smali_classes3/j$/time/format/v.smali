...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/format/v;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method constructor <init>(Lj$/time/format/G;Z)V
    ...
    invoke-direct {p0, v0, v1}, Lj$/time/format/u;-><init>(Lj$/time/temporal/TemporalQuery;Ljava/lang/String;)V
...
.method protected final a(Lj$/time/format/w;)Lj$/time/format/o;
    ...
    .line 4166
    :cond_4
    invoke-virtual {p1, v12, v12}, Lj$/time/format/o;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v10, v12}, Lj$/time/format/o;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final q(Lj$/time/format/y;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/y;->f(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/p;)Z
    ...
    invoke-static {v3}, Lj$/time/Instant;->B(Lj$/time/temporal/TemporalAccessor;)Lj$/time/Instant;
    ...
    .line 4114
    invoke-interface {v3, v7}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/p;)Z
    ...
    .line 4115
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/p;)J
    ...
    .line 4116
    invoke-interface {v3, v7}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/p;)J

    move-result-wide v7

    invoke-static {v7, v8}, Lj$/time/LocalTime;->X(J)Lj$/time/LocalTime;
    ...
    .line 4052
    :cond_3
    sget-object v3, Lj$/time/format/v;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 4097
    invoke-virtual {v7}, Lj$/time/format/G;->q()I
