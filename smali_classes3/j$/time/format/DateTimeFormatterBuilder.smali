...
.method private x(Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/q;)Lj$/time/format/DateTimeFormatter;
    .locals 3
    ...
    invoke-direct {v1, v0, p1, p2, p3}, Lj$/time/format/DateTimeFormatter;-><init>(Lj$/time/format/e;Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/q;)V
...
.method public final h(Lj$/time/format/G;)V
    .locals 2
...
.method public final i(Ljava/lang/String;)V
    ...
    .line 1990
    invoke-virtual {v0, v10}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/p;)V

    goto/16 :goto_10

    .line 1992
    :cond_a
    invoke-virtual {v0, v10, v3}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/p;I)V
    ...
    .line 1880
    invoke-direct {v0, v6}, Lj$/time/format/DateTimeFormatterBuilder;->l(Lj$/time/format/k;)V
    ...
    invoke-virtual {v0, v10, v3}, Lj$/time/format/DateTimeFormatterBuilder;->k(Lj$/time/temporal/p;Lj$/time/format/G;)V
    ...
    invoke-virtual {v0, v10, v8, v9, v3}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/p;IILj$/time/format/F;)V
    ...
    invoke-virtual {v0, v10, v8, v6, v3}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/p;IILj$/time/format/F;)V
    ...
    .line 1966
    invoke-virtual {v0, v10, v8}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/p;I)V
    ...
    invoke-virtual {v0, v3, v8, v8, v2}, Lj$/time/format/DateTimeFormatterBuilder;->b(Lj$/time/temporal/a;IIZ)V
    ...
    .line 1905
    :cond_29
    invoke-virtual {v0, v10, v11}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/p;I)V
    ...
    invoke-virtual {v0, v10, v3, v6, v4}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/p;IILj$/time/format/F;)V
    ...
    invoke-direct {v3, v4, v6}, Lj$/time/format/u;-><init>(Lj$/time/temporal/TemporalQuery;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lj$/time/format/DateTimeFormatterBuilder;->h(Lj$/time/format/G;)V
    ...
    .line 1794
    sget-object v6, Lj$/time/format/l;->d:[Ljava/lang/String;
    ...
    .line 1854
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatterBuilder;->q()V
...
.method public final j(Lj$/time/temporal/a;Ljava/util/HashMap;)V
    ...
    invoke-direct {v1, p1, p2, v0}, Lj$/time/format/s;-><init>(Lj$/time/temporal/p;Lj$/time/format/G;Lj$/time/format/B;)V
...
.method public final k(Lj$/time/temporal/p;Lj$/time/format/G;)V
    .locals 2
    ...
    invoke-static {}, Lj$/time/format/B;->c()Lj$/time/format/B;

    move-result-object v1

    invoke-direct {v0, p1, p2, v1}, Lj$/time/format/s;-><init>(Lj$/time/temporal/p;Lj$/time/format/G;Lj$/time/format/B;)V
...
.method public final m(Lj$/time/temporal/p;)V
    ...
    invoke-direct {v0, p1, v2, v3, v1}, Lj$/time/format/k;-><init>(Lj$/time/temporal/p;IILj$/time/format/F;)V
...
.method public final n(Lj$/time/temporal/p;I)V
    ...
    invoke-direct {v0, p1, p2, p2, v1}, Lj$/time/format/k;-><init>(Lj$/time/temporal/p;IILj$/time/format/F;)V
...
.method public final o(Lj$/time/temporal/p;IILj$/time/format/F;)V
    .locals 2
    ...
    .line 506
    invoke-virtual {p0, p1, p3}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/p;I)V
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Lj$/time/format/k;-><init>(Lj$/time/temporal/p;IILj$/time/format/F;)V
...
.method public final p()V
    ...
    invoke-direct {v0, v1, v2}, Lj$/time/format/u;-><init>(Lj$/time/temporal/TemporalQuery;Ljava/lang/String;)V
...
.method public toFormatter()Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {p0, v0}, Lj$/time/format/DateTimeFormatterBuilder;->w(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
...
.method final v(Lj$/time/format/E;Lj$/time/chrono/q;)Lj$/time/format/DateTimeFormatter;
    .locals 1
    ...
    invoke-direct {p0, v0, p1, p2}, Lj$/time/format/DateTimeFormatterBuilder;->x(Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/q;)Lj$/time/format/DateTimeFormatter;
...
.method public final w(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-direct {p0, p1, v0, v1}, Lj$/time/format/DateTimeFormatterBuilder;->x(Ljava/util/Locale;Lj$/time/format/E;Lj$/time/chrono/q;)Lj$/time/format/DateTimeFormatter;
