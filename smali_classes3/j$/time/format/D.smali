...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lj$/time/format/D;->h:Lj$/time/o;
...
.method private C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    .locals 5
...
.method private r(Lj$/time/temporal/TemporalAccessor;)V
    .locals 8
    ...
    .line 651
    :try_start_0
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/p;)J
...
.method private t()V
    ...
    .line 340
    invoke-direct {p0, v1}, Lj$/time/format/D;->u(Lj$/time/ZoneId;)V
    ...
    .line 345
    invoke-direct {p0, v0}, Lj$/time/format/D;->u(Lj$/time/ZoneId;)V

    :cond_1
    return-void
.end method

.method private u(Lj$/time/ZoneId;)V
    .locals 4
    ...
    invoke-static {v2, v3}, Lj$/time/Instant;->K(J)Lj$/time/Instant;
    ...
    invoke-interface {v2, v0, p1}, Lj$/time/chrono/j;->x(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;

    move-result-object p1

    .line 354
    invoke-interface {p1}, Lj$/time/chrono/ChronoZonedDateTime;->p()Lj$/time/chrono/ChronoLocalDate;

    move-result-object v0

    invoke-direct {p0, v0}, Lj$/time/format/D;->B(Lj$/time/chrono/ChronoLocalDate;)V
    ...
    invoke-direct {p0, v1, v0, p1}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
...
.method private w(JJJJ)V
    ...
    invoke-static {p5}, Lj$/time/o;->b(I)Lj$/time/o;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lj$/time/format/D;->z(Lj$/time/LocalTime;Lj$/time/o;)V
    ...
    invoke-virtual {v0, p3, p4}, Lj$/time/temporal/a;->c0(J)I
    ...
    invoke-virtual {p4, p7, p8}, Lj$/time/temporal/a;->c0(J)I
    ...
    invoke-static {p2}, Lj$/time/o;->b(I)Lj$/time/o;
    ...
    invoke-virtual {p7, p1, p2}, Lj$/time/temporal/a;->c0(J)I
    ...
    invoke-virtual {p2, p5, p6}, Lj$/time/temporal/a;->c0(J)I
...
.method private x()V
    ...
    .line 383
    :cond_0
    invoke-virtual {v1, v5, v6}, Lj$/time/temporal/a;->d0(J)V
    ...
    invoke-direct {p0, v1, v2, v5}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 391
    :cond_4
    invoke-virtual {v1, v7, v8}, Lj$/time/temporal/a;->d0(J)V
    ...
    invoke-direct {p0, v1, v2, v3}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 401
    :cond_8
    invoke-virtual {v1, v3, v4}, Lj$/time/temporal/a;->d0(J)V

    .line 402
    invoke-virtual {v2, v3, v4}, Lj$/time/temporal/a;->d0(J)V
    ...
    invoke-direct {p0, v1, v2, v7}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v1, v2, v9}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 427
    invoke-virtual {v1, v9, v10}, Lj$/time/temporal/a;->d0(J)V
    ...
    invoke-direct {p0, v1, v2, v11}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 454
    invoke-virtual {v1, v2, v3}, Lj$/time/temporal/a;->d0(J)V
    ...
    .line 459
    invoke-virtual {v4, v10, v11}, Lj$/time/temporal/a;->d0(J)V
    ...
    invoke-direct {p0, v4, v1, v7}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 467
    invoke-virtual {v4, v7, v8}, Lj$/time/temporal/a;->d0(J)V
    ...
    invoke-direct {p0, v4, v1, v2}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 480
    invoke-direct/range {v5 .. v13}, Lj$/time/format/D;->w(JJJJ)V

    :cond_19
    return-void
.end method

.method private z(Lj$/time/LocalTime;Lj$/time/o;)V
    .locals 4
    ...
    .line 618
    iget-object p1, p0, Lj$/time/format/D;->h:Lj$/time/o;
    ...
    .line 621
    :goto_0
    iput-object p2, p0, Lj$/time/format/D;->h:Lj$/time/o;
    ...
    iget-object v0, p0, Lj$/time/format/D;->h:Lj$/time/o;
...
.method public final g(Lj$/time/temporal/p;)Z
    ...
    .line 182
    invoke-interface {v0, p1}, Lj$/time/chrono/ChronoLocalDate;->g(Lj$/time/temporal/p;)Z
    ...
    .line 183
    invoke-virtual {v0, p1}, Lj$/time/LocalTime;->g(Lj$/time/temporal/p;)Z
...
.method final s(Lj$/time/format/E;)V
    .locals 26

    move-object/from16 v0, p0

    .line 249
    iget-object v9, v0, Lj$/time/format/D;->a:Ljava/util/HashMap;

    move-object/from16 v1, p1

    .line 252
    iput-object v1, v0, Lj$/time/format/D;->e:Lj$/time/format/E;

    .line 265
    invoke-direct {v0}, Lj$/time/format/D;->t()V

    .line 360
    iget-object v1, v0, Lj$/time/format/D;->c:Lj$/time/chrono/j;

    iget-object v2, v0, Lj$/time/format/D;->e:Lj$/time/format/E;

    invoke-interface {v1, v9, v2}, Lj$/time/chrono/j;->T(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object v1

    invoke-direct {v0, v1}, Lj$/time/format/D;->B(Lj$/time/chrono/ChronoLocalDate;)V

    .line 267
    invoke-direct {v0}, Lj$/time/format/D;->x()V
    ...
    .line 277
    iget-object v5, v0, Lj$/time/format/D;->e:Lj$/time/format/E;

    invoke-interface {v4, v9, v0, v5}, Lj$/time/temporal/p;->W(Ljava/util/HashMap;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/E;)Lj$/time/temporal/TemporalAccessor;
    ...
    .line 281
    iget-object v2, v0, Lj$/time/format/D;->b:Lj$/time/ZoneId;

    if-nez v2, :cond_1

    .line 282
    invoke-interface {v5}, Lj$/time/chrono/ChronoZonedDateTime;->U()Lj$/time/ZoneId;

    move-result-object v2

    iput-object v2, v0, Lj$/time/format/D;->b:Lj$/time/ZoneId;
    ...
    .line 286
    :goto_1
    invoke-interface {v5}, Lj$/time/chrono/ChronoZonedDateTime;->A()Lj$/time/chrono/ChronoLocalDateTime;
    ...
    .line 290
    invoke-interface {v5}, Lj$/time/chrono/ChronoLocalDateTime;->o()Lj$/time/LocalTime;

    move-result-object v2

    sget-object v3, Lj$/time/o;->d:Lj$/time/o;

    invoke-direct {v0, v2, v3}, Lj$/time/format/D;->z(Lj$/time/LocalTime;Lj$/time/o;)V

    .line 291
    invoke-interface {v5}, Lj$/time/chrono/ChronoLocalDateTime;->p()Lj$/time/chrono/ChronoLocalDate;

    move-result-object v2

    invoke-direct {v0, v2}, Lj$/time/format/D;->B(Lj$/time/chrono/ChronoLocalDate;)V
    ...
    invoke-direct {v0, v5}, Lj$/time/format/D;->B(Lj$/time/chrono/ChronoLocalDate;)V

    goto :goto_3

    .line 300
    :cond_5
    instance-of v2, v5, Lj$/time/LocalTime;
    ...
    invoke-direct {v0, v5, v2}, Lj$/time/format/D;->z(Lj$/time/LocalTime;Lj$/time/o;)V
    ...
    :cond_a
    :goto_4
    iget-object v1, v0, Lj$/time/format/D;->g:Lj$/time/LocalTime;
    ...
    invoke-direct {v0, v1, v4, v2}, Lj$/time/format/D;->C(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v0 .. v8}, Lj$/time/format/D;->w(JJJJ)V
    ...
    .line 535
    :goto_b
    iget-object v1, v0, Lj$/time/format/D;->e:Lj$/time/format/E;
    ...
    invoke-virtual {v4}, Lj$/time/temporal/a;->e0()Z
    ...
    invoke-virtual {v3, v4, v5}, Lj$/time/temporal/a;->d0(J)V
    ...
    :cond_16
    :goto_d
    iget-object v1, v0, Lj$/time/format/D;->f:Lj$/time/chrono/ChronoLocalDate;

    if-eqz v1, :cond_17

    .line 634
    invoke-direct {v0, v1}, Lj$/time/format/D;->r(Lj$/time/temporal/TemporalAccessor;)V
    ...
    iget-object v2, v0, Lj$/time/format/D;->g:Lj$/time/LocalTime;

    invoke-interface {v1, v2}, Lj$/time/chrono/ChronoLocalDate;->M(Lj$/time/LocalTime;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    iget-object v1, v0, Lj$/time/format/D;->h:Lj$/time/o;
    ...
    iget-object v3, v0, Lj$/time/format/D;->h:Lj$/time/o;

    invoke-interface {v1, v3}, Lj$/time/chrono/ChronoLocalDate;->P(Lj$/time/temporal/o;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object v1

    iput-object v1, v0, Lj$/time/format/D;->f:Lj$/time/chrono/ChronoLocalDate;

    .line 572
    iput-object v2, v0, Lj$/time/format/D;->h:Lj$/time/o;
    ...
    .line 602
    iget-object v2, v0, Lj$/time/format/D;->f:Lj$/time/chrono/ChronoLocalDate;

    iget-object v3, v0, Lj$/time/format/D;->g:Lj$/time/LocalTime;

    invoke-interface {v2, v3}, Lj$/time/chrono/ChronoLocalDate;->M(Lj$/time/LocalTime;)Lj$/time/chrono/ChronoLocalDateTime;

    move-result-object v2

    invoke-interface {v2, v1}, Lj$/time/chrono/ChronoLocalDateTime;->I(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;

    move-result-object v1

    invoke-interface {v1}, Lj$/time/chrono/ChronoZonedDateTime;->S()J
    ...
    invoke-interface {v1, v2}, Lj$/time/chrono/ChronoLocalDateTime;->I(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
