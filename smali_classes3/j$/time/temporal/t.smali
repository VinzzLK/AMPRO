...
.method private constructor <init>(Ljava/lang/String;Lj$/time/temporal/u;Lj$/time/temporal/TemporalUnit;Lj$/time/temporal/TemporalUnit;Lj$/time/temporal/s;)V
    .locals 0
    ...
    iput-object p3, p0, Lj$/time/temporal/t;->c:Ljava/lang/Enum;

    .line 764
    check-cast p4, Ljava/lang/Enum;

    iput-object p4, p0, Lj$/time/temporal/t;->d:Ljava/lang/Enum;
...
.method private b(Lj$/time/temporal/TemporalAccessor;)I
    ...
    invoke-virtual {v0}, Lj$/time/temporal/u;->e()Lj$/time/DayOfWeek;

    move-result-object v0

    invoke-virtual {v0}, Lj$/time/DayOfWeek;->q()I
...
.method private c(Lj$/time/temporal/TemporalAccessor;)I
    ...
    .line 822
    invoke-direct {p0, p1}, Lj$/time/temporal/t;->b(Lj$/time/temporal/TemporalAccessor;)I
    ...
    .line 833
    :cond_0
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->l(Lj$/time/temporal/p;)Lj$/time/temporal/s;
    ...
    invoke-virtual {v2}, Lj$/time/temporal/u;->f()I
...
.method private d(Lj$/time/temporal/TemporalAccessor;)I
    ...
    .line 860
    invoke-static {p1}, Lj$/time/chrono/j;->F(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/j;
    ...
    .line 862
    invoke-direct {p0, p1}, Lj$/time/temporal/t;->d(Lj$/time/temporal/TemporalAccessor;)I
    ...
    .line 866
    invoke-interface {p1, v1}, Lj$/time/temporal/TemporalAccessor;->l(Lj$/time/temporal/p;)Lj$/time/temporal/s;
    ...
    invoke-virtual {v1}, Lj$/time/temporal/u;->f()I
...
.method static e(Lj$/time/temporal/u;)Lj$/time/temporal/t;
    .locals 6
...
.method private f(Lj$/time/chrono/j;III)Lj$/time/chrono/ChronoLocalDate;
    .locals 3

    const/4 v0, 0x1

    .line 741
    invoke-interface {p1, p2, v0, v0}, Lj$/time/chrono/j;->G(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 746
    invoke-interface {p1}, Lj$/time/chrono/ChronoLocalDate;->L()I
...
.method static g(Lj$/time/temporal/u;)Lj$/time/temporal/t;
    .locals 6
    ...
    invoke-virtual {v1}, Lj$/time/temporal/a;->B()Lj$/time/temporal/s;
...
.method static h(Lj$/time/temporal/u;)Lj$/time/temporal/t;
    .locals 6
...
.method static i(Lj$/time/temporal/u;)Lj$/time/temporal/t;
    .locals 6
...
.method private j(Lj$/time/temporal/TemporalAccessor;Lj$/time/temporal/a;)Lj$/time/temporal/s;
    .locals 3
    ...
    .line 1130
    invoke-interface {p1, p2}, Lj$/time/temporal/TemporalAccessor;->l(Lj$/time/temporal/p;)Lj$/time/temporal/s;
...
.method private k(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/s;
    .locals 6
    ...
    .line 1153
    invoke-direct {p0, p1}, Lj$/time/temporal/t;->k(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/s;
    ...
    .line 1156
    :cond_1
    invoke-interface {p1, v0}, Lj$/time/temporal/TemporalAccessor;->l(Lj$/time/temporal/p;)Lj$/time/temporal/s;
    ...
    invoke-virtual {v4}, Lj$/time/temporal/u;->f()I
    ...
    invoke-interface {v1, p1}, Lj$/time/chrono/j;->u(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/ChronoLocalDate;
...
.method public final K(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/s;
    ...
    iget-object v1, p0, Lj$/time/temporal/t;->d:Ljava/lang/Enum;
    ...
    invoke-direct {p0, p1, v0}, Lj$/time/temporal/t;->j(Lj$/time/temporal/TemporalAccessor;Lj$/time/temporal/a;)Lj$/time/temporal/s;
    ...
    .line 1112
    :cond_2
    sget-object v0, Lj$/time/temporal/u;->h:Lj$/time/temporal/TemporalUnit;
...
.method public final W(Ljava/util/HashMap;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/E;)Lj$/time/temporal/TemporalAccessor;
    ...
    iget-object v7, v0, Lj$/time/temporal/t;->d:Ljava/lang/Enum;

    const/4 v8, 0x0

    iget-object v9, v0, Lj$/time/temporal/t;->e:Lj$/time/temporal/s;

    const/4 v10, 0x7

    iget-object v11, v0, Lj$/time/temporal/t;->b:Lj$/time/temporal/u;
    ...
    .line 938
    invoke-virtual {v9, v3, v4, v0}, Lj$/time/temporal/s;->a(JLj$/time/temporal/p;)I

    move-result v2

    .line 939
    invoke-virtual {v11}, Lj$/time/temporal/u;->e()Lj$/time/DayOfWeek;

    move-result-object v3

    invoke-virtual {v3}, Lj$/time/DayOfWeek;->q()I
    ...
    invoke-virtual {v3, v13, v14}, Lj$/time/temporal/a;->c0(J)I
    ...
    invoke-virtual {v13}, Lj$/time/DayOfWeek;->q()I
    ...
    .line 954
    invoke-static/range {p2 .. p2}, Lj$/time/chrono/j;->F(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/j;
    ...
    invoke-virtual {v14, v10, v11}, Lj$/time/temporal/a;->c0(J)I
    ...
    .line 976
    invoke-interface {v7, v6, v5, v5}, Lj$/time/chrono/j;->G(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v2, v5, v6, v10}, Lj$/time/chrono/ChronoLocalDate;->b(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object v2

    .line 802
    invoke-direct {v0, v2}, Lj$/time/temporal/t;->b(Lj$/time/temporal/TemporalAccessor;)I
    ...
    invoke-interface {v2, v6}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/p;)I
    ...
    .line 981
    invoke-virtual {v11, v8, v9}, Lj$/time/temporal/a;->c0(J)I
    ...
    .line 982
    invoke-interface {v7, v6, v5, v10}, Lj$/time/chrono/j;->G(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 983
    invoke-virtual {v10, v12, v13, v0}, Lj$/time/temporal/s;->a(JLj$/time/temporal/p;)I
    ...
    .line 802
    invoke-direct {v0, v5}, Lj$/time/temporal/t;->b(Lj$/time/temporal/TemporalAccessor;)I
    ...
    invoke-interface {v5, v12}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/p;)I

    move-result v12

    .line 804
    invoke-direct {v0, v12, v10}, Lj$/time/temporal/t;->l(II)I

    move-result v10

    .line 805
    invoke-static {v10, v12}, Lj$/time/temporal/t;->a(II)I
    ...
    invoke-interface {v4, v11}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/p;)J
    ...
    .line 1000
    invoke-interface {v8, v6, v5, v5}, Lj$/time/chrono/j;->G(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v5, v6}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/p;)I
    ...
    .line 1006
    :cond_6
    invoke-virtual {v10, v11, v12, v0}, Lj$/time/temporal/s;->a(JLj$/time/temporal/p;)I
    ...
    invoke-interface {v5, v10}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/p;)I
    ...
    invoke-interface {v4, v14}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/p;)J
    ...
    .line 964
    sget-object v5, Lj$/time/temporal/u;->h:Lj$/time/temporal/TemporalUnit;
    ...
    :cond_a
    invoke-static {v11}, Lj$/time/temporal/u;->b(Lj$/time/temporal/u;)Lj$/time/temporal/p;
    ...
    invoke-static {v11}, Lj$/time/temporal/u;->c(Lj$/time/temporal/u;)Lj$/time/temporal/p;
    ...
    .line 1022
    invoke-virtual {v5, v9, v10, v7}, Lj$/time/temporal/s;->a(JLj$/time/temporal/p;)I
    ...
    .line 1026
    invoke-direct {v0, v8, v5, v10, v4}, Lj$/time/temporal/t;->f(Lj$/time/chrono/j;III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 1031
    invoke-virtual {v6, v9, v10, v7}, Lj$/time/temporal/s;->a(JLj$/time/temporal/p;)I

    move-result v6

    .line 1033
    invoke-direct {v0, v8, v5, v6, v4}, Lj$/time/temporal/t;->f(Lj$/time/chrono/j;III)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-direct {v0, v4}, Lj$/time/temporal/t;->c(Lj$/time/temporal/TemporalAccessor;)I
...
.method public final q(Lj$/time/temporal/Temporal;J)Lj$/time/temporal/Temporal;
    ...
    .line 917
    :cond_0
    iget-object v2, p0, Lj$/time/temporal/t;->d:Ljava/lang/Enum;
    ...
    invoke-static {v0}, Lj$/time/temporal/u;->a(Lj$/time/temporal/u;)Lj$/time/temporal/p;
    ...
    .line 921
    invoke-static {v0}, Lj$/time/temporal/u;->c(Lj$/time/temporal/u;)Lj$/time/temporal/p;
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lj$/time/temporal/t;->f(Lj$/time/chrono/j;III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 925
    iget-object v0, p0, Lj$/time/temporal/t;->c:Ljava/lang/Enum;
...
.method public final s(Lj$/time/temporal/TemporalAccessor;)J
    ...
    .line 784
    invoke-direct {p0, p1}, Lj$/time/temporal/t;->c(Lj$/time/temporal/TemporalAccessor;)I
