...
# instance fields
.field private final a:Lj$/time/chrono/j;
...
.method constructor <init>(Lj$/time/chrono/j;III)V
    .locals 0
...
.method public final q(Lj$/time/chrono/ChronoLocalDate;)Lj$/time/temporal/Temporal;
    ...
    invoke-interface {p1, v0}, Lj$/time/temporal/TemporalAccessor;->e(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v3}, Lj$/time/chrono/j;->Y(Lj$/time/temporal/a;)Lj$/time/temporal/s;

    move-result-object v1

    .line 247
    invoke-virtual {v1}, Lj$/time/temporal/s;->g()Z

    move-result v3

    if-eqz v3, :cond_3

    invoke-virtual {v1}, Lj$/time/temporal/s;->h()Z
    ...
    invoke-interface {p1, v0, v1, v3}, Lj$/time/temporal/Temporal;->b(JLj$/time/temporal/TemporalUnit;)Lj$/time/temporal/Temporal;
