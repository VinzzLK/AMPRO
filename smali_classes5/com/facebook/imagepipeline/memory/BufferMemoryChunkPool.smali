...
# virtual methods
.method protected nvG(I)LTso/D;
    .locals 1

    .line 1
    new-instance v0, LTso/D;

    .line 2
    .line 3
    invoke-direct {v0, p1}, LTso/D;-><init>(I)V
...
.method protected bridge synthetic q(I)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/facebook/imagepipeline/memory/BufferMemoryChunkPool;->nvG(I)LTso/D;
