...
# static fields
.field private static hUw:LUz/xfY;
...
.method private static R6(Ljava/io/InputStream;)Ljava/io/InputStream;
    .locals 2
...
.method private static cD(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)[B
    .locals 2
...
.method private static createBitmap(IILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 16
    :cond_0
    sget-object p2, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->hUw:LUz/xfY;
    ...
    .line 19
    .line 20
    invoke-interface {p2, p0, p1, v0}, LUz/xfY;->hUw(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method public static hookDecodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->x(Ljava/lang/String;)V
...
.method public static hookDecodeFileDescriptor(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->R6(Ljava/io/InputStream;)Ljava/io/InputStream;

    move-result-object v2

    .line 4
    :try_start_0
    invoke-static {v2, p2}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->cD(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)[B
...
.method public static hookDecodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 2
    invoke-static {p0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->R6(Ljava/io/InputStream;)Ljava/io/InputStream;
...
# virtual methods
.method public hUw(LUz/xfY;)V
    .locals 0

    .line 1
    sput-object p1, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->hUw:LUz/xfY;
...
.method public j(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 0
