...
.method public final a(Ljava/lang/String;Landroid/view/MotionEvent;)V
    ...
    invoke-static {v1}, LY6/xfY;->hUw(Landroid/content/Context;)LY6/xfY;
    ...
    invoke-virtual {v1, v2, p2}, LY6/xfY;->cD(Landroid/net/Uri;Landroid/view/InputEvent;)Lcom/google/common/util/concurrent/XSt;
    ...
    .line 6
    invoke-static {v0}, LT4i/xfY;->hUw(Landroid/content/Context;)Ljava/util/concurrent/Executor;

    move-result-object p1

    .line 7
    invoke-interface {p2, v1, p1}, Lcom/google/common/util/concurrent/XSt;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
