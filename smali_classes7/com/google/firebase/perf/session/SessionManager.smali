...
.method private constructor <init>()V
    ...
    invoke-static {v1}, Lcom/google/firebase/perf/session/PerfSession;->cD(Ljava/lang/String;)Lcom/google/firebase/perf/session/PerfSession;
    ...
    .line 4
    invoke-direct {p0, v0, v1, v2}, Lcom/google/firebase/perf/session/SessionManager;-><init>(Lcom/google/firebase/perf/session/gauges/GaugeManager;Lcom/google/firebase/perf/session/PerfSession;Lcom/google/firebase/perf/application/xfY;)V

    return-void
.end method

.method public constructor <init>(Lcom/google/firebase/perf/session/gauges/GaugeManager;Lcom/google/firebase/perf/session/PerfSession;Lcom/google/firebase/perf/application/xfY;)V
    .locals 1
    ...
    .line 9
    iput-object p3, p0, Lcom/google/firebase/perf/session/SessionManager;->appStateMonitor:Lcom/google/firebase/perf/application/xfY;
...
.method public static synthetic j(Lcom/google/firebase/perf/session/SessionManager;Landroid/content/Context;Lcom/google/firebase/perf/session/PerfSession;)V
    .locals 1
    ...
    .line 5
    .line 6
    invoke-virtual {p2}, Lcom/google/firebase/perf/session/PerfSession;->R6()Z
    ...
    .line 13
    .line 14
    invoke-virtual {p2}, Lcom/google/firebase/perf/session/PerfSession;->X()Ljava/lang/String;
    ...
    .line 18
    sget-object p2, Lr0R/h;->x:Lr0R/h;

    .line 19
    .line 20
    invoke-virtual {p0, p1, p2}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->logGaugeMetadata(Ljava/lang/String;Lr0R/h;)Z
...
.method private logGaugeMetadataIfCollectionEnabled(Lr0R/h;)V
    .locals 2
    ...
    .line 12
    .line 13
    invoke-virtual {v1}, Lcom/google/firebase/perf/session/PerfSession;->X()Ljava/lang/String;
    ...
    .line 17
    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->logGaugeMetadata(Ljava/lang/String;Lr0R/h;)Z
...
.method private startOrStopCollectingGauges(Lr0R/h;)V
    .locals 2
    ...
    .line 12
    .line 13
    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->startCollectingGauges(Lcom/google/firebase/perf/session/PerfSession;Lr0R/h;)V
...
.method public initializeGaugeCollection()V
    ...
    .line 2
    .line 3
    invoke-direct {p0, v0}, Lcom/google/firebase/perf/session/SessionManager;->logGaugeMetadataIfCollectionEnabled(Lr0R/h;)V

    .line 4
    .line 5
    .line 6
    invoke-direct {p0, v0}, Lcom/google/firebase/perf/session/SessionManager;->startOrStopCollectingGauges(Lr0R/h;)V
...
.method public onUpdateAppState(Lr0R/h;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lcom/google/firebase/perf/application/A;->onUpdateAppState(Lr0R/h;)V

    .line 2
    .line 3
    .line 4
    iget-object v0, p0, Lcom/google/firebase/perf/session/SessionManager;->appStateMonitor:Lcom/google/firebase/perf/application/xfY;

    .line 5
    .line 6
    invoke-virtual {v0}, Lcom/google/firebase/perf/application/xfY;->q()Z
    ...
    .line 25
    invoke-static {p1}, Lcom/google/firebase/perf/session/PerfSession;->cD(Ljava/lang/String;)Lcom/google/firebase/perf/session/PerfSession;
    ...
    .line 34
    .line 35
    invoke-virtual {v0}, Lcom/google/firebase/perf/session/PerfSession;->q()Z
    ...
    .line 57
    :cond_2
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->startOrStopCollectingGauges(Lr0R/h;)V
...
.method public setApplicationContext(Landroid/content/Context;)V
    ...
    .line 7
    new-instance v2, LIWN/A;

    .line 8
    .line 9
    invoke-direct {v2, p0, p1, v0}, LIWN/A;-><init>(Lcom/google/firebase/perf/session/SessionManager;Landroid/content/Context;Lcom/google/firebase/perf/session/PerfSession;)V
...
.method public updatePerfSession(Lcom/google/firebase/perf/session/PerfSession;)V
    ...
    .line 44
    .line 45
    invoke-interface {v2, p1}, LIWN/xfY;->hUw(Lcom/google/firebase/perf/session/PerfSession;)V
    ...
    .line 56
    iget-object p1, p0, Lcom/google/firebase/perf/session/SessionManager;->appStateMonitor:Lcom/google/firebase/perf/application/xfY;

    .line 57
    .line 58
    invoke-virtual {p1}, Lcom/google/firebase/perf/application/xfY;->hUw()Lr0R/h;
    ...
    .line 62
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->logGaugeMetadataIfCollectionEnabled(Lr0R/h;)V
