...
# No re-encoding: original codec/bitrate/FPS preserved
...
.method public static doReverse(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    move-result v5
    if-gtz v5, :buf_ok
    const/high16 v5, 0x200000  # 2MB fallback
    :buf_ok
    ...
    invoke-virtual {v10}, Ljava/nio/ByteBuffer;->get([B)Ljava/nio/ByteBuffer;
    ...
    :has_frames
    # Setup MediaMuxer output
    new-instance v0, Landroid/media/MediaMuxer;
    const/4 v9, 0x0  # MUXER_OUTPUT_MPEG_4
    ...
    # Calculate frame duration: total_duration / frame_count  
    # Default 33333us (~30fps) — safe fallback
    const-wide/32 v12, 0x82B5  # 33333us
    const/4 v10, 0x0
    const-wide/16 v2, 0x0  # running PTS
    ...
    long-to-int v5, v2, v3   # convert PTS long to passing

    # set(int offset, int size, long pts, int flags)
    const/4 v5, 0x0
    invoke-virtual {v4, v5, v14, v2, v3, v12, v13}, Landroid/media/MediaCodec$BufferInfo;->set(IJIJ)V
